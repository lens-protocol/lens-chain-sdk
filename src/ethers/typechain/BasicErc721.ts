...
export interface BasicErc721Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface BasicErc721 extends BaseContract {
  connect(runner?: ContractRunner | null): BasicErc721;
  waitForDeployment(): Promise<this>;

  interface: BasicErc721Interface;
